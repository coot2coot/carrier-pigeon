...
function bookingConfirmationEmail (order, sender) {
	var jobNumber 	= formatJobId(order.job_number, order.date);
	...
	'<html xmlns="http://www.w3.org/1999/xhtml">' +
		...
		'<body>' +
			'<div>' +
				'<p>Hi,</pp>' +
				'<p>Please find attached the booking confirmation.</p>' +
				'<p>Our Reference: ' + jobNumber + '.</p>' +
        '<p>Please quote the booking reference on all communication.</p>' +
				'<p>For any queries or general information please email ' + sender + '</p>' +
				'<br>' +
				'<p>Yours Sincerely,</p>' +
